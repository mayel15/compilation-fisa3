...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SUJET = 3,                      /* SUJET  */
  YYSYMBOL_VERBE = 4,                      /* VERBE  */
  YYSYMBOL_ADJECTIF = 5,                   /* ADJECTIF  */
  YYSYMBOL_ADVERBE = 6,                    /* ADVERBE  */
  YYSYMBOL_YYACCEPT = 7,                   /* $accept  */
  YYSYMBOL_phrase = 8,                     /* phrase  */
  YYSYMBOL_COMPLEMENT = 9                  /* COMPLEMENT  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "SUJET", "VERBE",
  "ADJECTIF", "ADVERBE", "$accept", "phrase", "COMPLEMENT", YY_NULLPTR
};
